        ...
        <div className="flex flex-col min-h-screen">
            ...
            <section className="relative pt-24 pb-20 md:pt-32 md:pb-32 overflow-hidden">
                ...
                <div className="container mx-auto px-4 md:px-6 relative z-10 text-center max-w-4xl">
                    <motion.div
                        ...
                        className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-orange-100 text-primary text-sm font-medium mb-8"
                    >
                    ...
                    <motion.h1
                        ...
                        className="text-5xl md:text-7xl font-bold font-heading text-slate-900 leading-[1.1] tracking-tight mb-8"
                    >
                    ...
                    >
                        Web Development <span className="text-slate-300 mx-2">|</span> App Development <span className="text-slate-300 mx-2">|</span> Content Promotion
                    </motion.p>
                    ...
                    >
                        <Link
                            href="/contact"
                            className="w-full sm:w-auto px-8 py-4 bg-primary hover:bg-primary-hover text-white rounded-full font-medium text-lg transition-transform hover:scale-105 active:scale-95 shadow-lg shadow-primary/20 flex items-center justify-center gap-2 group"
                        >
                            Get Started
                        ...
                        <Link
                            href="/services"
                            className="w-full sm:w-auto px-8 py-4 bg-white text-slate-700 hover:text-primary rounded-full font-medium text-lg transition-colors border border-slate-200 shadow-sm flex items-center justify-center"
                        >
                            Explore Services
                        </Link>
                    </motion.div>
            ...
            <section className="py-16 bg-white border-y border-slate-100">
                <div className="container mx-auto px-4 md:px-6">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 divide-x divide-slate-100"
                    >
                        {[
                            { label: "Clients", value: <AnimatedStats end={10} suffix="+" /> },
                            { label: "Projects", value: <AnimatedStats end={20} suffix="+" />, primary: true },
                            { label: "Years Experience", value: <AnimatedStats end={2} suffix="+" /> },
                            ...
                            >
                                <div className={`text-4xl md:text-5xl ${stat.primary ? 'text-primary font-bold' : 'text-slate-900'} mb-2`}>
                                    {stat.value}
                                </div>
                                <p className="text-sm md:text-base text-slate-500 font-medium">{stat.label}</p>
                            </motion.div>
                        ))}
                    </motion.div>
                </div>
            ...
            <section className="py-24 bg-slate-50 relative">
                <div className="container mx-auto px-4 md:px-6">
                    ...
                    >
                        {/* Service Card 1 */}
                        <motion.div variants={fadeInUp} className="bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-xl hover:-translate-y-1 transition-all group">
                            <div className="w-14 h-14 bg-orange-100 text-primary rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                            ...
                            <Link href="/services#web" className="inline-flex items-center text-secondary font-medium hover:text-primary transition-colors">
                                Learn More <ArrowRight className="w-4 h-4 ml-1" />
                            </Link>
                        </motion.div>

                        {/* Service Card 2 */}
                        <motion.div variants={fadeInUp} className="bg-white rounded-2xl p-8 shadow-md border border-slate-100 hover:shadow-xl hover:-translate-y-1 transition-all group relative overflow-hidden">
                            <div className="absolute top-0 left-0 w-full h-1 bg-primary"></div>
                            <div className="w-14 h-14 bg-blue-50 text-secondary rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                            ...
                            <Link href="/services#app" className="inline-flex items-center text-secondary font-medium hover:text-primary transition-colors">
                                Learn More <ArrowRight className="w-4 h-4 ml-1" />
                            </Link>
                        </motion.div>
                        ...
                        <motion.div variants={fadeInUp} className="bg-white rounded-2xl p-8 shadow-sm border border-slate-100 hover:shadow-xl hover:-translate-y-1 transition-all group">
                            ...
                            <Link href="/services#content" className="inline-flex items-center text-secondary font-medium hover:text-primary transition-colors">
                                Learn More <ArrowRight className="w-4 h-4 ml-1" />
                            </Link>
                        </motion.div>
                    </motion.div>
                ...
                <div className="container mx-auto px-4 md:px-6 mb-12">
                    ...
                    >
                        <div className="max-w-2xl">
                            <h2 className="text-3xl md:text-4xl font-bold font-heading text-slate-900 mb-4">Featured Projects</h2>
                            <p className="text-slate-600 text-lg">Explore some of our recent work across various industries.</p>
                        </div>
                        <Link href="/projects" className="shrink-0 inline-flex flex-row items-center justify-center px-6 py-3 border-2 border-slate-200 rounded-full text-slate-700 hover:border-primary hover:text-primary font-medium transition-colors">
                            View All Projects
                        </Link>
                    </motion.div>
                </div>
                ...
                >
                    <Carousel speed={35} items={[
                        ...
                        <div key="p3" className="w-[300px] md:w-[400px] h-[250px] bg-slate-300 rounded-2xl flex flex-col justify-end p-6 border border-slate-200 relative overflow-hidden group">
                            <Image src="https://images.unsplash.com/photo-1504674900247-0877df9cc836?auto=format&fit=crop&q=80&w=800&h=500" alt="Restaurant ordering" fill className="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
                            <div className="absolute inset-0 bg-gradient-to-t from-slate-900/80 to-transparent z-10"></div>
                            <div className="relative z-20">
            ...
            <section className="py-24 bg-white relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 md:px-6 relative z-10">
                    ...
                    >
                        <h2 className="text-4xl md:text-5xl font-bold font-heading text-slate-900 mb-6">Ready to Transform Your Business?</h2>
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                            <Link
                                href="/contact"
                                className="w-full sm:w-auto px-8 py-4 bg-secondary hover:bg-slate-800 text-white rounded-full font-medium text-lg transition-colors shadow-lg shadow-secondary/20"
                            >
                                Start a Project
                            </Link>
                            <Link
                                href="/contact"
                                className="w-full sm:w-auto px-8 py-4 bg-primary hover:bg-primary-hover text-white rounded-full font-medium text-lg transition-colors shadow-lg shadow-primary/20"
                            >
                                Contact Us
                            </Link>
                        </div>
